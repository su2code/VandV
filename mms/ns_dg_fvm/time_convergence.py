...
#       ax1.set_ylabel(result[i].columns.values[3], fontsize=8)
#       ax1.tick_params(axis='both', labelsize=8)
#       # ax1.legend(loc="center left", bbox_to_anchor=(.9, 0.5), prop={'size': 6})
#       ax1.set_title(result[i].columns.values[3] + "TS: " + str(ts[0]))
#       fig1.savefig((result[i].columns.values[3][9:12]) +
#                    "_"+str(ts[0])+"_ts.png")

#       ax2.set_xlabel("Time Iter", fontsize=8)
#       ax2.set_ylabel(result[i+1].columns.values[3], fontsize=8)
#       ax2.tick_params(axis='both', labelsize=8)
#       # ax2.legend(loc="center left", bbox_to_anchor=(.9, 0.5), prop={'size': 6})
#       ax2.set_title(result[i+1].columns.values[3] + "TS: " + str(ts[1]))
#       fig2.savefig((result[i+1].columns.values[3][9:12]) +
#                    "_"+str(ts[1])+"_ts.png")

#       ax3.set_xlabel("Time Iter", fontsize=8)
#       ax3.set_ylabel(result[i+2].columns.values[3], fontsize=8)
#       ax3.tick_params(axis='both', labelsize=8)
#       # ax3.legend(loc="center left", bbox_to_anchor=(.9, 0.5), prop={'size': 6})
#       ax3.set_title(result[i+2].columns.values[3] + "TS: " + str(ts[2]))
#       fig3.savefig((result[i+2].columns.values[3][9:12]) +
#                    "_"+str(ts[2])+"_ts.png")

#       ax4.set_xlabel("Time Iter", fontsize=8)
#       ax4.set_ylabel(result[i+3].columns.values[3], fontsize=8)
#       ax4.tick_params(axis='both', labelsize=8)
#       # ax4.legend(loc="center left", bbox_to_anchor=(.9, 0.5), prop={'size': 6})
#       ax4.set_title(result[i+3].columns.values[3] + "TS: " + str(ts[3]))
#       fig4.savefig((result[i+3].columns.values[3][9:12]) +
#                    "_"+str(ts[3])+"_ts.png")
