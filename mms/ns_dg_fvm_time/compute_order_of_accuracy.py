...
fnames = ["lam_mms_roe_sst.cfg","lam_mms_roe_lim_sst.cfg","lam_mms_roe_wls_sst.cfg","lam_mms_jst_sst.cfg", "lam_mms_dg_sst.cfg"]

# list of variables from the current solver to plot
variables = ["rho", "rhou", "rhov", "rhoe"]

# set the legend tags for each config
legends = ["ROE+GG", "ROE+GG+LIM", "ROE+WLS","JST+GG","DG"]
