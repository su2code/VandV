...
## \file bump_plotter_sst.py
#  \brief Python script for post-processing the turbulent 2D bump-in-channel SST solution.
...
# Some other constants from the bump case for non-dim.
a     = 347.223789508
a2    = a*a
mu    = 1.84592e-05
rho   = 0.797432
...
h4 = mlab.csv2rec("history_0089x041_sst.csv", comments='#', skiprows=0, checkrows=0)
h3 = mlab.csv2rec("history_0177x081_sst.csv", comments='#', skiprows=0, checkrows=0)
h2 = mlab.csv2rec("history_0353x161_sst.csv", comments='#', skiprows=0, checkrows=0)
h1 = mlab.csv2rec("history_0705x321_sst.csv", comments='#', skiprows=0, checkrows=0)
h0 = mlab.csv2rec("history_1409x641_sst.csv", comments='#', skiprows=0, checkrows=0)
...
plt.title(r'Residual Convergence for a Turbulent 2D Bump-in-Channel (SST)', fontsize=12)
...
plt.savefig('bump_residual_convergence_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)

# Load the grid convergence data for the integrated quantities
cfl3d = mlab.csv2rec("cfl3d_gridconv_sst.csv", comments='#', skiprows=0, checkrows=0)
fun3d = mlab.csv2rec("fun3d_gridconv_sst.csv", comments='#', skiprows=0, checkrows=0)
...
plt.title(r'Lift Grid Convergence for a Turbulent 2D Bump-in-Channel (SST)', fontsize=12)
...
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.13)
plt.savefig('bump_cl_gridconv_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)
...
plt.title(r'Drag Grid Convergence for a Turbulent 2D Bump-in-Channel (SST)', fontsize=12)
...
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.13)
plt.savefig('bump_cd_gridconv_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)

# Load the surface data for the bump on all grids
cf4_data = mlab.csv2rec("surface_0089x041_sst.csv", comments='#', skiprows=0, checkrows=0)
cf3_data = mlab.csv2rec("surface_0177x081_sst.csv", comments='#', skiprows=0, checkrows=0)
cf2_data = mlab.csv2rec("surface_0353x161_sst.csv", comments='#', skiprows=0, checkrows=0)
cf1_data = mlab.csv2rec("surface_0705x321_sst.csv", comments='#', skiprows=0, checkrows=0)
cf0_data = mlab.csv2rec("surface_1409x641_sst.csv", comments='#', skiprows=0, checkrows=0)
...
plt.ylim([0.0047,0.0052])
plt.xlim([0.0,0.012])
plt.xlabel(r'$h = \sqrt{1/N}$', fontsize=20)
plt.ylabel(r'$C_f$ @ $x = 0.6321975$', fontsize=20)
plt.title(r'Skin Friction Grid Convergence for a Turbulent 2D Bump-in-Channel (SST)', fontsize=12)
...
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.13)
plt.savefig('bump_cf_0p63_gridconv_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)
...
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.13)
plt.savefig('bump_cf_0p75_gridconv_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)
...
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.13)
plt.savefig('bump_cf_0p87_gridconv_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)
...
cfl3d_cf = mlab.csv2rec("cfl3d_cf_bump_sst.csv", comments='#', skiprows=0, checkrows=0)
fun3d_cf = mlab.csv2rec("fun3d_cf_bump_sst.csv", comments='#', skiprows=0, checkrows=0)
...
plt.title(r'Skin Friction Coefficient on 1409x641 2D Bump-in-Channel Grid (SST)', fontsize=12)
plt.legend([r'CFL3D',r'FUN3D',r'SU2'],loc=1,fontsize=16)
for label in plt.gca().get_xticklabels() + plt.gca().get_yticklabels():
  label.set_fontsize(13)
plt.grid('on')
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.13)
plt.savefig('bump_cf_profile_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)

# Load the pressure coefficient along the bump for the 1409x641 grid
su2_x    = zeros(len(cf0_data.x[:]))
su2_cp   = zeros(len(cf0_data.x[:]))
cfl3d_cp = mlab.csv2rec("cfl3d_cp_bump_sst.csv", comments='#', skiprows=0, checkrows=0)
fun3d_cp = mlab.csv2rec("fun3d_cp_bump_sst.csv", comments='#', skiprows=0, checkrows=0)
...
plt.title(r'Pressure Coefficient on 1409x641 2D Bump-in-Channel Grid (SST)', fontsize=12)
plt.legend([r'CFL3D',r'FUN3D',r'SU2'],loc=1,fontsize=16)
for label in plt.gca().get_xticklabels() + plt.gca().get_yticklabels():
  label.set_fontsize(13)
plt.grid('on')
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.13)
plt.savefig('bump_cp_profile_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)

# Load various quantities for comparing slices at x = 0.75 on the 1409x641 grid.
cf0_data = mlab.csv2rec("profile_1409x641_sst.csv", comments='#', skiprows=0, checkrows=0)
cfl3d_cp = mlab.csv2rec("cfl3d_omega_k_sst.csv", comments='#', skiprows=0, checkrows=0)
fun3d_cp = mlab.csv2rec("fun3d_omega_k_sst.csv", comments='#', skiprows=0, checkrows=0)
cfl3d_mu = mlab.csv2rec("cfl3d_eddy_visc_sst.csv", comments='#', skiprows=0, checkrows=0)
fun3d_mu = mlab.csv2rec("fun3d_eddy_visc_sst.csv", comments='#', skiprows=0, checkrows=0)
cfl3d_v  = mlab.csv2rec("cfl3d_velocity_sst.csv", comments='#', skiprows=0, checkrows=0)
...
plt.title(r'Non-dim. Eddy Viscosity on 1409x641 2D Bump-in-Channel Grid (SST)', fontsize=12)
plt.legend([r'CFL3D',r'FUN3D',r'SU2'],loc=1,fontsize=16)
for label in plt.gca().get_xticklabels() + plt.gca().get_yticklabels():
  label.set_fontsize(13)
plt.grid('on')
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.13)
plt.savefig('bump_eddy_profile_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)

# Plot the k comparison
plt.clf()
plt.figure(figsize=(800/my_dpi, 600/my_dpi), dpi=my_dpi)
plt.loglog(cfl3d_cp.k_nondim[:],cfl3d_cp.y[:]-0.05,linestyle='-', marker='', color='green',linewidth = 1.5, markersize=6)
plt.loglog(fun3d_cp.k_nondim[:],fun3d_cp.y[:]-0.05,linestyle='-.', marker='', color='red',linewidth = 1.5, markersize=6)
plt.loglog(cf0_data.k[:]/a2,cf0_data.y[:]-0.05,linestyle='--', marker='', color='blue',linewidth = 1.5, markersize=6)
plt.ylim([1e-7,1e-1])
plt.xlim([1e-11,1e-3])
plt.xlabel(r'$k / a_{\infty}^2$ @ $x = 0.75$', fontsize=20)
plt.ylabel(r'$y - 0.05$', fontsize=20)
plt.title(r'Non-dim. TKE on 1409x641 2D Bump-in-Channel Grid (SST)', fontsize=12)
plt.legend([r'CFL3D',r'FUN3D',r'SU2'],loc=4,fontsize=16)
for label in plt.gca().get_xticklabels() + plt.gca().get_yticklabels():
  label.set_fontsize(13)
plt.grid('on')
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.14)
plt.savefig('bump_k_profile_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)

# Plot the omega comparison
plt.clf()
plt.figure(figsize=(800/my_dpi, 600/my_dpi), dpi=my_dpi)
plt.loglog(cfl3d_cp.omega_nondim[:],cfl3d_cp.y[:]-0.05,linestyle='-', marker='', color='green',linewidth = 1.5, markersize=6)
plt.loglog(fun3d_cp.omega_nondim[:],fun3d_cp.y[:]-0.05,linestyle='-.', marker='', color='red',linewidth = 1.5, markersize=6)
plt.loglog(cf0_data.o[:]*mu/(rho*a2),cf0_data.y[:]-0.05,linestyle='--', marker='', color='blue',linewidth = 1.5, markersize=6)
plt.ylim([1e-7,1e-1])
plt.xlim([1e-9,1e-0])
plt.xlabel(r'$\omega \mu_{\infty}/(\rho_{\infty} a_{\infty}^2)$ @ $x = 0.75$', fontsize=20)
plt.ylabel(r'$y - 0.05$', fontsize=20)
plt.title(r'Non-dim. Dissipation on 1409x641 2D Bump-in-Channel Grid (SST)', fontsize=12)
plt.legend([r'CFL3D',r'FUN3D',r'SU2'],loc=1,fontsize=16)
for label in plt.gca().get_xticklabels() + plt.gca().get_yticklabels():
  label.set_fontsize(13)
plt.grid('on')
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.14)
plt.savefig('bump_omega_profile_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)
...
plt.ylabel(r'$y - 0.05$', fontsize=20)
plt.title(r'Non-dim. Velocity on 1409x641 2D Bump-in-Channel Grid (SST)', fontsize=12)
...
plt.gcf().subplots_adjust(left=0.18)
plt.gcf().subplots_adjust(bottom=0.13)
plt.savefig('bump_vel_profile_sst.%s'%(imgfrm),format=imgfrm,dpi=my_dpi*4)
